...
namespace BACKEND.Domains
{
    public partial class GufosContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=N-1S-DEV-15\\SQLEXPRESS; database=Gufos; User Id=sa; Password=132");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categoria>(entity =>
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Categori__7B406B56C42080DA")
                    .IsUnique();
            ...
            modelBuilder.Entity<Evento>(entity =>
            {
                ...
                entity.HasOne(d => d.Categoria)
                    ...
                    .HasConstraintName("FK__Evento__Categori__440B1D61");
            ...
            modelBuilder.Entity<Localizacao>(entity =>
            {
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Localiza__AA57D6B456CE7E68")
                    .IsUnique();
            ...
            modelBuilder.Entity<Presenca>(entity =>
            {
                ...
                entity.HasOne(d => d.Evento)
                    ...
                    .HasConstraintName("FK__Presenca__Evento__48CFD27E");
            ...
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Tipo_usu__7B406B568EEF5EB6")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D105342FCC6B7A")
                    .IsUnique();
